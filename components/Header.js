	...
	return (
		<>
			<header className='w-full px-6 border-b-2 border-black flex justify-between justify-between items-center text-sm font-messapia font-bold'>
				...
				<button
					onClick={toggleNav}
					className='md:hidden justify-start icone-toggle bg-transparent rounded-full p-2 inline-flex items-center justify-center h-12 w-12'
				>
					<img
						src='/img/menu.png'
						alt='menu hamburger'
						className='h-[30px] w-[30px] ml-2 mr-auto '
					/>
				</button>
				</div>
				...
				<div className='w-1/3  flex items-center justify-end space-x-5 ml-auto'>
					...
					<Link href={'/contact'}>
						<a className='font-bold text-xs animate-changeColor ml-auto'>
							Say Hi !
						</a>
					</Link>
				</div>
