...
function Pills({ locale, blockText, setBlockText }) {
	...
	return (
		<div className='flex flex-col items-center space-y-3 mx-auto lg:font-bold font-messapia text-xs p-1 lg:p-2'>
			...
			<p className={`w-full text-xs text-center font-sweet-sans-pro font-normal lg:hidden ${blockText === 1 ? "block" : "hidden"}`}>
				{locale === 'fr'
			...
			<p className={`w-full text-xs text-center font-sweet-sans-pro font-normal lg:hidden ${blockText === 2 ? "block" : "hidden"}`}>
				{locale === 'fr'
			...
			<p className={`w-full text-xs text-center font-sweet-sans-pro font-normal lg:hidden ${blockText === 3 ? "block" : "hidden"}`}>
				{locale === 'fr'
			...
			<p className={`w-full text-xs text-center font-sweet-sans-pro font-normal lg:hidden ${blockText === 4 ? "block" : "hidden"}`}>
				{locale === 'fr'
			...
			<p className={`w-full text-xs text-center font-sweet-sans-pro font-normal lg:hidden ${blockText === 5 ? "block" : "hidden"}`}>
				{locale === 'fr'
			...
			<p className={`w-full text-xs text-center font-sweet-sans-pro font-normal lg:hidden ${blockText === 6 ? "block" : "hidden"}`}>
				{locale === 'fr'
