...
function SayHi() {
  return (
<Marquee className='border-2 border-black text-2xl md:text-6xl font-agrandir-grand pb-3 md-pb-0 pt-4 lg:pb-2 font-bold' speed={100} gradient={false} direction='right'>
